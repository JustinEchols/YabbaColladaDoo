...
set CommonCompilerFlags= -Od -nologo -W4 -wd4100 -wd4996 -wd4505 -DGLEW_STATIC=1 -D__CRT_SECURE_NO_WARNINGS=1 -Zi
...
REM cl ..\src\%MainFile% %CommonCompilerFlags%  -Od -nologo -W4 -wd4100 -wd4996 -wd4505 -Zi
